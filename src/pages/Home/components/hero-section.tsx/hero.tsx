    ...
    <>
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
        <div className="flex flex-col justify-center items-center w-full">
          <div className="flex w-[340px] flex-end justify-end items-end translate-x-80 absolute top-52">
          ...
          <div className="text-white text-6xl font-medium pointer-events-auto tracking-wider">
